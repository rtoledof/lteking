...
func TestDirectionService_GetRoute(t *testing.T) {
	var tests = []struct {
		...
		request cubawheeler.DirectionRequest
		want    *cubawheeler.DirectionResponse
		wantErr bool
	}{
		{
			name: "valid request",
				...
				Routes: []*cubawheeler.Route{
					{
						...
						Legs: []*cubawheeler.Legs{
							{
								Summary:  "Köpenicker Straße, Engeldamm",
								Duration: 26.2,
								Distance: 176.7,
								Weight:   44.4,
								Steps: []cubawheeler.Step{
									{
										Intersections: []*cubawheeler.Intersection{
											{
												Location: []float64{13.426579, 52.508068},
												Bearings: []int{125},
												Entry:    []bool{true},
										...
										Distance: 98.1,
										VoiceInstructions: []*cubawheeler.VoiceInstructions{
											{
										...
										BannerInstructions: []*cubawheeler.BannerInstructions{
											{
												DistanceAlongGeometry: 98.1,
												Primary: &cubawheeler.Primary{
													Text:       "Engeldamm",
													Type:       "turn",
													Modifier:   "right",
													Components: []*cubawheeler.Component{{Text: "Engeldamm"}},
												},
											},
										},
									},
										...
										BannerInstructions: []*cubawheeler.BannerInstructions{
											{
												...
												Primary: &cubawheeler.Primary{
													...
													Type:       "arrive",
													Modifier:   "straight",
													Components: []*cubawheeler.Component{{Text: "You will arrive at your destination"}},
												},
												Secondary: &cubawheeler.Primary{
													Text:       "Engeldamm",
													Type:       "arrive",
													Modifier:   "straight",
													Components: []*cubawheeler.Component{{Text: "Engeldamm"}},
											...
											},
											{
												...
												Primary: &cubawheeler.Primary{
													...
													Type:       "arrive",
													Modifier:   "straight",
													Components: []*cubawheeler.Component{{Text: "You have arrived at your destination"}},
												},
												Secondary: &cubawheeler.Primary{
													Text:       "Engeldamm",
													Components: []*cubawheeler.Component{{Text: "Engeldamm"}},
