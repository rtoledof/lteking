...
func TestValuesBasicTypes(t *testing.T) {
	tests := []struct {
		input interface{}
		want  url.Values
	}{
...
func TestValuesPointers(t *testing.T) {
	str := "s"
	strPtr := &str
...
func TestValuesSlices(t *testing.T) {
	tests := []struct {
		input interface{}
		want  url.Values
	}{
...
func TestValuesNestedTypes(t *testing.T) {
...
func TestValuesEmbeddedStructs(t *testing.T) {
	type Inner struct {
		V string
	}
	type Outer struct {
...
func TestValuesCustomEncodingSlice(t *testing.T) {
	tests := []struct {
		input interface{}
		want  url.Values
	}{
...
func TestValuesCustomEncodingError(t *testing.T) {
	type st struct {
...
func TestValuesCustomEncodingInt(t *testing.T) {
...
func TestValuesCustomEncodingPointer(t *testing.T) {
